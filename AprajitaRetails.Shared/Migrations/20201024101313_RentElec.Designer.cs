...
namespace AprajitaRetails.Migrations
{
    ...
    [Migration("20201024101313_RentElec")]
    partial class RentElec
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.BankAccount", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.BankTranscation", b =>
                {
                    ...
                    b.ToTable("BankTranscations");
                });

            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.Expense", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.Payment", b =>
                {
                    ...
                    b.ToTable("PaymentVochers");
                });

            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.Receipt", b =>
                {
                    ...
                    b.ToTable("ReceiptVochers");
                });

            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.EBillPayment", b =>
                {
                    ...
                    b.Property<int?>("BillEletricityBillId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BillEletricityBillId");

                    b.ToTable("BillPayments");
                });

            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.ElectricityConnection", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.EletricityBill", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.Rent", b =>
                {
                    ...
                    b.Property<int?>("LocationRentedLocationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LocationRentedLocationId");

                    b.ToTable("Rents");
                });

            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.RentedLocation", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Models.Voy.VBInvoice", b =>
                {
                    b.Property<int>("VBInvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("BillGrossAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasKey("VBInvoiceId");

                    b.ToTable("VBInvoices");
                });

            modelBuilder.Entity("AprajitaRetails.Models.Voy.VBLineItem", b =>
                {
                    b.Property<int>("VBLineItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("VBLineItemId");

                    b.HasIndex("VBInvoiceid");

                    b.ToTable("VBLineItems");
                });

            modelBuilder.Entity("AprajitaRetails.Models.Voy.VBPaymentDetail", b =>
                {
                    b.Property<int>("VBPaymentDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("VBPaymentDetailId");

                    b.HasIndex("VBInvoiceid");

                    b.ToTable("VBPaymentDetails");
                });
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.BankTranscation", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Accountings.Models.BankAccount", "Account")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accountings.Models.Expense", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Accountings.Models.BankAccount", "FromAccount")
                        .WithMany()
                        .HasForeignKey("BankAccountId");
                    ...
                    b.HasOne("AprajitaRetails.Areas.Accountings.Models.LedgerEntry", "LedgerEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.EBillPayment", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Accounts.Models.EletricityBill", "Bill")
                        .WithMany()
                        .HasForeignKey("BillEletricityBillId");
                });

            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.EletricityBill", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Accounts.Models.ElectricityConnection", "Connection")
                        .WithMany()
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Accounts.Models.Rent", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Accounts.Models.RentedLocation", "Location")
                        .WithMany()
                        .HasForeignKey("LocationRentedLocationId");
                });
            ...
            modelBuilder.Entity("AprajitaRetails.Models.Voy.VBLineItem", b =>
                {
                    b.HasOne("AprajitaRetails.Models.Voy.VBInvoice", "Invoice")
                        .WithMany("VBLineItems")
                        .HasForeignKey("VBInvoiceid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
