...
namespace AprajitaRetails.Areas.Accounts.Controllers
{
    ...
    public class CashInHandsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
       [Authorize(Roles = "Admin,PowerUser")]     public async Task<IActionResult> Edit(int id, [Bind("CashInHandId,CIHDate,OpenningBalance,ClosingBalance,CashIn,CashOut")] CashInHand cashInHand)
        {
