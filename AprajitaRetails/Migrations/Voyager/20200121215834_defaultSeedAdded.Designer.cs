...
namespace AprajitaRetails.Migrations.Voyager
{
    ...
    [Migration("20200121215834_defaultSeedAdded")]
    partial class defaultSeedAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.CardPaymentDetail", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.ProductItem", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.ProductPurchase", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.PurchaseItem", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.PurchaseTaxType", b =>
                {
                    b.Property<int>("PurchaseTaxTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SaleInvoice", b =>
                {
                    b.Property<int>("SaleInvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SaleItem", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SalePaymentDetail", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SaleTaxType", b =>
                {
                    b.Property<int>("SaleTaxTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SalesPerson", b =>
                {
                    b.Property<int>("SalesPersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.Stock", b =>
                {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.CardPaymentDetail", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.SalePaymentDetail", "SalePaymentDetail")
                        .WithOne("CardDetails")
                        .HasForeignKey("AprajitaRetails.Areas.Voyager.Models.CardPaymentDetail", "CardPaymentDetailId")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.ProductItem", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.Brand", "BrandName")
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.Category", "MainCategory")
                        .WithMany()
                        .HasForeignKey("MainCategoryCategoryId");

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.Category", "ProductCategory")
                        .WithMany()
                        .HasForeignKey("ProductCategoryCategoryId");

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.Category", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.ProductPurchase", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.Supplier", "Supplier")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.PurchaseItem", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.ProductItem", "ProductItem")
                        .WithMany("PurchaseItems")
                        .HasForeignKey("ProductItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.ProductPurchase", "ProductPurchase")
                        .WithMany("PurchaseItems")
                        .HasForeignKey("ProductPurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.PurchaseTaxType", "PurchaseTaxType")
                        .WithMany("PurchaseItems")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SaleItem", b =>
                {
                    ...
                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.SaleInvoice", "SaleInvoice")
                        .WithMany("SaleItems")
                        .HasForeignKey("SaleInvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.SaleTaxType", "SaleTaxType")
                        .WithMany("SaleItems")
                        .HasForeignKey("SaleTaxTypeId");

                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.SalesPerson", "Salesman")
                        .WithMany("SaleItems")
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.SalePaymentDetail", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Voyager.Models.SaleInvoice", "SaleInvoice")
                        ...
                        .HasForeignKey("AprajitaRetails.Areas.Voyager.Models.SalePaymentDetail", "SalePaymentDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
