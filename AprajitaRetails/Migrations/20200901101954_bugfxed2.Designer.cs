...
namespace AprajitaRetails.Migrations
{
    ...
    [Migration("20200901101954_bugfxed2")]
    partial class bugfxed2
    {
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Voyager.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 0,
                            City = "Dumka",
                            CreatedDate = new DateTime(2020, 9, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            DateOfBirth = new DateTime(2020, 9, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            FirstName = "Cash",
                            Gender = 0,
                            LastName = "Sale",
                            MobileNo = "1234567890",
            ...
            modelBuilder.Entity("AprajitaRetails.Areas.Sales.Models.Views.CardDetail", b =>
                {
                    b.HasOne("AprajitaRetails.Areas.Sales.Models.Views.PaymentDetail", "PaymentDetail")
                        .WithOne("CardDetail")
                        .HasForeignKey("AprajitaRetails.Areas.Sales.Models.Views.CardDetail", "PaymentDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
