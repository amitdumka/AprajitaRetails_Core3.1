...
namespace AprajitaRetails.Ops.Triggers
{
    ...
    {
        //StoreBased Action 
        public void ProcessOpenningBalance(AprajitaRetailsContext db, DateTime date, int StoreId, bool saveit = false)
        {
        ...
        //StoreBased Action
        public void ProcessClosingBalance(AprajitaRetailsContext db, DateTime date, int StoreId, bool saveit = false)
        {
            CashInHand today;
            today = db.CashInHands.Where(c => c.CIHDate.Date == date.Date && c.StoreId == StoreId).FirstOrDefault();
            if (today != null)
        ...
        //StoreBased Action
        public void ProcessBankOpenningBalance(AprajitaRetailsContext db, DateTime date, int StoreId, bool saveit = false)
        {
        ...
        //StoreBased Action
        public void ProcessBankClosingBalance(AprajitaRetailsContext db, DateTime date, int StoreId, bool saveit = false)
        {
            CashInBank today;
            today = db.CashInBanks.Where(c => c.CIBDate.Date == date.Date && c.StoreId == StoreId).FirstOrDefault();
            if (today != null)
        ...
        //StoreBased Action
        public void JobOpeningClosingBalance(AprajitaRetailsContext db, int StoreId)
        {
        ...
        //StoreBased Action
        public void CreateNextDayOpenningBalance(AprajitaRetailsContext db, DateTime date, int StoreId, bool saveit = false)
        {
        ...
        //StoreBased Action
        public decimal GetClosingBalance(AprajitaRetailsContext db, DateTime forDate, int StoreId, bool IsBank = false)
        {
            if (IsBank)
            {
        ...
        //StoreBased Action
        public void CashInHandCorrectionForMonth(AprajitaRetailsContext db, DateTime forDate, int StoreId)
        {
        ...
        //StoreBased Action
        public void CashInBankCorrectionForMonth(AprajitaRetailsContext db, DateTime forDate, int StoreId)
        {
